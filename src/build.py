...
src = src.replace('/*YEAR_CORE*/', open(os.path.join(here, 'year-tour.js'), encoding='utf-8').read())
src = src.replace('/*YEAR_UI*/', open(os.path.join(here, 'year-tour-ui.js'), encoding='utf-8').read())
src = src.replace('/*SYSTEM_CORE*/', open(os.path.join(here, 'system-scale.js'), encoding='utf-8').read() + '\n' + open(os.path.join(here, 'galaxy-view.js'), encoding='utf-8').read())
src = src.replace('/*SYSTEM_UI*/', open(os.path.join(here, 'system-view.js'), encoding='utf-8').read())
